# -*- coding: utf-8 -*-
"""
Created on Wed Feb  2 11:42:18 2022
...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output<0:
            ...
            return render_template('index.html',prediction_text="You Can Sell The Car at Price Rs(Lakh): {}".format(output))
    else:
        return render_template('index.html')
